...
export default function Footer() {
  return (
    <footer
      className="bg-black text-center text-neutral-600 rounded-t-lg  dark:text-neutral-200 lg:text-left lg:h-[calc(435px+2rem)]">
      <div
        ...
        <div className="flex justify-center">
          <a className="mr-6 text-neutral-600 dark:text-neutral-200 hover:text-white cursor-pointer">
            <svg
          ...
          <a className="text-neutral-600 dark:text-neutral-200 hover:text-white cursor-pointer">
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="h-4 w-4"
              fill="currentColor"
      ...
      <div className="mx-6 py-10 text-center md:text-left">
        <div className="flex flex-col gap-10 justify-between items-center md:flex-row">
          ...
          <div className="">
            <h6
              className="mb-4 flex items-center text-white justify-center font-semibold uppercase md:justify-start">
              <svg
                xmlns="http://www.w3.org/2000/svg"
                viewBox="0 0 24 24"
                fill="currentColor"
            ...
            <p>
              One website to get the estimate cost of all your events
            </p>
          </div>
          {/* <!-- Products section --> */}
          {/* <div className="">
      ...
      {/* <!--Copyright section--> */}
      <div className="white p-6 pb-[5rem] text-center dark:bg-black">
